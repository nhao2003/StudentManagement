...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Data Source=DESKTOP-L09GMD1\\SQLEXPRESS09;Initial Catalog=QUANLYHOCSINH;Integrated Security=True");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Diemmonhoc>(entity =>
            {
                entity.HasKey(e => new { e.Mahs, e.Mahk, e.Mamh, e.Malkt })
                    .HasName("PK__DIEMMONH__C4AB4E68A2C845E4");
            ...
            modelBuilder.Entity<Giaovien>(entity =>
            {
                entity.HasKey(e => e.Magv)
                    .HasName("PK__GIAOVIEN__603F38B1B9DAFA70");
                ...
                entity.HasMany(d => d.Mamhs)
                    .WithMany(p => p.Magvs)
                    .UsingEntity<Dictionary<string, object>>(
                        "Khananggiangday",
                        l => l.HasOne<Monhoc>().WithMany().HasForeignKey("Mamh").OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("FK__KHANANGGIA__MAMH__778AC167"),
                        r => r.HasOne<Giaovien>().WithMany().HasForeignKey("Magv").OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("FK__KHANANGGIA__MAGV__76969D2E"),
                        j =>
                        {
                            j.HasKey("Magv", "Mamh").HasName("PK__KHANANGG__C63CCE2F9BE0FA1E");

                            j.ToTable("KHANANGGIANGDAY");

                            j.IndexerProperty<string>("Magv").HasMaxLength(7).HasColumnName("MAGV");

                            j.IndexerProperty<string>("Mamh").HasMaxLength(7).HasColumnName("MAMH");
                        });
            });
            ...
            modelBuilder.Entity<Hanhkiem>(entity =>
            {
                entity.HasKey(e => e.MaHanhKiem)
                    .HasName("PK__HANHKIEM__2B2C87ED2855DB3C");
            ...
            modelBuilder.Entity<Hocky>(entity =>
            {
                entity.HasKey(e => e.Mahk)
                    .HasName("PK__HOCKY__603F20C5FC95036B");
            ...
            modelBuilder.Entity<Hocluc>(entity =>
            {
                entity.HasKey(e => e.MaHocLuc)
                    .HasName("PK__HOCLUC__97954DD546690648");
            ...
            modelBuilder.Entity<Hocsinh>(entity =>
            {
                entity.HasKey(e => e.Mahs)
                    .HasName("PK__HOCSINH__603F20DDD7418620");
            ...
            modelBuilder.Entity<Ketqua>(entity =>
            {
                entity.HasKey(e => e.MaKetQua)
                    .HasName("PK__KETQUA__D5B3102A9D6BCC7C");
            ...
            modelBuilder.Entity<Khananggiangday>(entity =>
            {
                entity.HasKey(e => new { e.Magv, e.Mamh })
                    .HasName("PK__KHANANGG__C63CCE2F9BE0FA1E");
                ...
                entity.HasOne<Khananggiangday>()
                    .WithMany()
                    .HasForeignKey(d => d.Magv)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__KHANANGGIA__MAGV__76969D2E");

                entity.HasOne<Khananggiangday>()
                    .WithMany()
                    .HasForeignKey(d => d.Mamh)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__KHANANGGIA__MAMH__778AC167");
            });

            modelBuilder.Entity<Kqhockymonhoc>(entity =>
            {
                entity.HasKey(e => new { e.Mahs, e.Mamh, e.Mahk, e.Manh })
                    .HasName("PK__KQHOCKYM__12EAEA967CCD5860");
            ...
            modelBuilder.Entity<Kqhockytonghop>(entity =>
            {
                entity.HasKey(e => new { e.Mahs, e.Mahk, e.Manh })
                    .HasName("PK__KQHOCKYT__2D5CED803FE13735");
            ...
            modelBuilder.Entity<Kqnamhoc>(entity =>
            {
                entity.HasKey(e => new { e.Mahs, e.Manh })
                    .HasName("PK__KQNAMHOC__D63CD5CDC25A97DA");
            ...
            modelBuilder.Entity<Loaikiemtra>(entity =>
            {
                entity.HasKey(e => e.Malkt)
                    .HasName("PK__LOAIKIEM__7A3D008E19FD1F19");
            ...
            modelBuilder.Entity<Lop>(entity =>
            {
                entity.HasKey(e => e.Malop)
                    .HasName("PK__LOP__7A3DE21158ADD7D9");
            ...
            modelBuilder.Entity<Lophocthucte>(entity =>
            {
                entity.HasKey(e => e.Malhtt)
                    .HasName("PK__LOPHOCTH__353317E44C437A10");
                ...
                entity.HasMany(d => d.Mahs)
                    ...
                    .UsingEntity<Dictionary<string, object>>(
                        ...
                        j =>
                        {
                            j.HasKey("Malhtt", "Mahs").HasName("PK__LOPHOCTH__F330E5E9AEE57553");
            ...
            modelBuilder.Entity<Monhoc>(entity =>
            {
                entity.HasKey(e => e.Mamh)
                    .HasName("PK__MONHOC__603F69EB754E4A35");
            ...
            modelBuilder.Entity<Namhoc>(entity =>
            {
                entity.HasKey(e => e.Manh)
                    .HasName("PK__NAMHOC__603F510AFE96E61B");
            ...
            modelBuilder.Entity<Nhanvienphongdaotao>(entity =>
            {
                entity.HasKey(e => e.Manv)
                    .HasName("PK__NHANVIEN__603F51142D02C804");
            ...
            modelBuilder.Entity<Phanconggiangday>(entity =>
            {
                entity.HasKey(e => new { e.Manh, e.Malhtt, e.Mamh, e.Magv })
                    .HasName("PK__PHANCONG__520A5CEE09D99D92");
                ...
                entity.HasOne(d => d.MalhttNavigation)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__PHANCONGG__MALHT__7B5B524B");

                entity.HasOne(d => d.ManhNavigation)
                    .WithMany(p => p.Phanconggiangdays)
                    .HasForeignKey(d => d.Manh)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__PHANCONGGI__MANH__7A672E12");
            ...
            modelBuilder.Entity<Phh>(entity =>
            {
                entity.HasKey(e => e.Maphhs)
                    .HasName("PK__PHHS__5401D0A549226D28");
            ...
            modelBuilder.Entity<Taikhoan>(entity =>
            {
                entity.HasKey(e => e.Username)
                    .HasName("PK__TAIKHOAN__B15BE12F2A87ABB8");
